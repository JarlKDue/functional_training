...
public interface Convert_Old_Address_To_New {
    ...
    static Function<Customer_Address_Old, Optional<Customer_Address_New>> convert_old_customer_adress_to_new_customer_adress = customer_address_old -> Optional.of(new Customer_Address_New(
